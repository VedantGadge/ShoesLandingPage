    ...
    <section id="home" className="w-full border-2 border-red-400 p-2 flex flex-col xl:flex-row justify-center min-h-screen gap-10 max-container ">
      ...
      <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((statistic)=> (<div key={statistic.label}>
            <p className=" font-palanquin font-bold text-4xl ">{statistic.value}</p>
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center ">
        <img src={bigShoe1} alt="Shoe collection" height={500} width={610} className=" object-contain relative z-10 "/>
